        ...
        <div id="carouselExampleIndicators" class="carousel slide bg-yellow" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="./images/PALM4A.jpg" class="d-block w-100" alt="..." style="width:100%; height:110%;">
                </div>

                <div class="carousel-item">
                    <img src="./images/PALM6A.png" class="d-block w-100" alt="..." style="width:100%; height:110%;">
                </div>
                <div class="carousel-item">
                    <img src="./images/PALM5A.png" class="d-block w-100" alt="..." style="width:100%; pheight:110%;">
                </div>
            </div>
...
<div class="row">
  ...
  <div class="col-lg-4 col-md-6 col-sm-6 ">
    <div class="content men-pro-item"><img src="./images/<?php echo $row['image'];?>" alt="Mountains" style="width:100%; max-height:50%;">
      <h6><?php echo $row['title'];?></h6>
      <p class="gallery-price"><b>Price </b>$<?php echo $row['price'];?></p>
