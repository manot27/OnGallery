...
.carousel-control-next{
    ...
    <body>
        ...
        <div id="carouselExampleIndicators" class="carousel slide bg-yellow" data-bs-ride="carousel">
...
<div class="row">
  <div class="column nature">
    <div class="content">
      <img src="./images/imma12.jpg" alt="Mountains" style="width:100%; max-height:50%;">
      <h6>FRONT FACE</h6>
  ...
  <div class="column nature">
    <div class="content">
    <img src="./images/imma16.jpg" alt="Lights" style="width:100%; max-height:50%;">
      <h6>Back Face</h6>
      <p class="gallery-price"><b>Price </b>$199.99</p>
                  <button  class=" btn-primary col-md-2" style="font-size:8pt">Apply</button>
  ...
  <div class="column nature">
    <div class="content">
    <img src="./images/imma10.jpg" alt="Nature" style="width:100%; max-height:50%;">
      <h6>More Back Face</h6>
      <p class="gallery-price"><b>Price </b>$199.99</p>
                      <button  class=" btn-primary col-md-2" style="font-size:8pt">Apply</button>
  ...
  <div class="column cars">
    <div class="content">
      <img src="./images/imma15.jpg" alt="Car" style="width:100%; max-height:50%;">
      <h6>Front Face</h6>
      <p class="gallery-price"><b>Price </b>$199.99</p>
                      <button  class=" btn-primary col-md-2" style="font-size:8pt">Apply</button>
  ...
  <div class="column cars">
    <div class="content">
    <img src="./images/imma16.jpg" alt="Car" style="width:100%; max-height:40%;">
      <h6>Back Face</h6>
      <p class="gallery-price"><b>Price </b>$199.99</p>
                      <button  class=" btn-primary col-md-2" style="font-size:8pt">Apply</button>
  ...
  <div class="column cars">
    <div class="content">
    <img src="./images/imma13.jpg" alt="Car" style="width:100%; max-height:50%;">
      <h6>Side Face</h6>
      <p class="gallery-price"><b>Price </b>$199.99</p>
                    <button  class=" btn-primary col-md-2" style="font-size:8pt">Apply</button>
  ...
  <div class="column people">
    <div class="content">
      <img src="./images/imma11.jpg" alt="Car" style="width:100%; max-height:50%;">
      <h6>FRONT FACE</h6>
      <p class="gallery-price"><b>Price </b>$199.99</p>
                      <button  class=" btn-primary col-md-2" style="font-size:8pt">Apply</button>
  ...
  <div class="column people">
    <div class="content">
    <img src="./images/imma14.jpg" alt="Car" style="width:100%; max-height:50%;">
     <h6>Face & Body</h6>
      <p class="gallery-price"><b>Price </b>$199.99</p>
                      <button  class=" btn-primary col-md-2" style="font-size:8pt">Apply</button>
